	...
	return (
		<div className='mt-40'>
			...
			<form className='flex flex-col ml-96' onSubmit={handleSubmit(addToQueue)}>
				...
				<input
					className='border-2 border-gray border-solid pl-4 rounded w-3/5 h-10 mb-2'
					type='text'
				...
				/>
				<button className='mt-4 ml-20 bg-purple-800 text-white rounded w-2/5 h-10'>
					<Link to='/dashboard'>Join the queue</Link>
				</button>
			</form>
		</div>
	);
